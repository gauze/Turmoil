; Theoretically this can also be called from a "MOVE" - but I was actually to lazy to do and test that
; should bring a few cycles - between 12 - 170! (tested ???)
; but some sounds in music were off - havent examined it - wasn't worth the trouble!
